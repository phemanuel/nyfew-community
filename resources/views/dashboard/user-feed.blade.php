            ...
            <form id="create-post-form">
                ...
                <div class="flex flex-1 items-start space-x-4 p-5">
                    ...
                    <div class="flex-1 pt-2">
                        <textarea name="content" id="content" class="uk-textare text-black shadow-none focus:shadow-none text-xl font-medium resize-none" rows="5"
...
$(document).ready(function () {
    ...
    // Comment on Post (delegated)
    $('#posts-container').on('keypress', '.comment-input', function (e) {
        ...
        $('#share-post-btn').click(function (e) {
            ...
            $.ajax({
                ...
                error: function (xhr) {
                    ...
                    if (errors) {
                        let message = Object.values(errors).map(e => `<div>${e}</div>`).join('');
